...
#elif (defined(__APPLE__) && ((defined(TARGET_OS_IOS) && TARGET_OS_IOS) || (defined(TARGET_OS_TV) && TARGET_OS_TV))) || defined(__ANDROID__)
      int nArgs = 2;
      string szPath = m_vpinball.m_szMyPath + "res/exampleTable.vpx";
      char* szArglist[] = {
         (char*)"-play",
         (char*)szPath.c_str(),
      };
